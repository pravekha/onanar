    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-8 py-10">
      ...
      <div className="bg-white border border-[#D8CFC2] rounded-sm p-4 mb-8">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Select testId="filter-deadline" value={filters.deadline_status} onChange={set("deadline_status")}
            options={[{ value: "closing_soon", label: "Closing in 7 days" }, { value: "closing_month", label: "Closing in 30 days" }, { value: "open", label: "Open" }, { value: "closed", label: "Closed" }]}
      ...
      {loading ? (
        ...
        <div data-testid="directory-grid" className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {opps.map((o) => <OpportunityCard key={o.id} opp={o} saved={savedIds.has(o.id)} onToggleSave={toggleSave} />)}
        </div>
      )}
    </main>
  );
